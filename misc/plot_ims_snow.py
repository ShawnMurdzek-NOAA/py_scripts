...
#template = '/work2/noaa/wrfruc/murdzek/RRFS_input_data/snow/ims96/grib2/22%03d2200000000.grib2'
template = '/work2/noaa/wrfruc/murdzek/nature_run_winter/synthetic_ims/22%03d2200000000.grib2'
#fnames = [template % i for i in range(119, 126)]
